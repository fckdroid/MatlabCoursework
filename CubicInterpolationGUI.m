classdef CubicInterpolationGUI < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function onBtnFindMinClick(app)
            ...
            axis(app.UIAxes, [-5*double(xMin) 7*double(xMin) -double(yMin) 7*double(yMin)])
            plot(app.UIAxes, xMin,yMin,'o')
            hold(app.UIAxes,'on')
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.BtnFindMin.ButtonPushedFcn = createCallbackFcn(app, @onBtnFindMinClick);
